...
googl_ticks = mt5.copy_ticks_range(
    "GOOGL",
    datetime(2022, 1, 27, 16, tzinfo=utc),
    datetime(2022, 1, 27, 21, tzinfo=utc),
    mt5.COPY_TICKS_ALL,
)

# get 10 bars over 4 hours from 12. January 2022 20:00 UTC for both NVDA and GOOGL
nvda_rates = mt5.copy_rates_from(
    "NVDA", mt5.TIMEFRAME_H4, datetime(2022, 1, 12, 20, tzinfo=utc), 10
)
googl_rates = mt5.copy_rates_from(
    "GOOGL", mt5.TIMEFRAME_H4, datetime(2022, 1, 12, 20, tzinfo=utc), 10
)
